...
public class CloudFormationCleanupService {

	static AmazonCloudFormation cloudFormation;
	static LambdaLogger LOGGER = null;

	public static  void startCleanup(LambdaLogger pLogger,String pworkShopStartDate,String pworkShopEndtDate) {
	...
	/*					String workShopStartDate = System.getenv("WORKSHOP_START_DATE"); // DD-MM-YYYY format
						...
						*/
						String workShopStartDate = pworkShopStartDate ;

						String workShopEndDate = pworkShopEndtDate ;
			...
			ex.printStackTrace();
			String logMessage;
			logMessage = "Message is " + ex.getMessage();
			LOGGER.log(logMessage);
			LOGGER.log("Stack trace is  " + ex.getStackTrace().toString());

		}

	} // if region !=

	private static void initialze(String regionName) {
