...
public class CreateSecurityGroupApp {
     ...
     *      (C:\\Users\\sonali.shinde\\.aws\\credentials) where the sample code will load the
     *      credentials from.
    ...
    public static void main(String[] args) {
         ...
         * (C:\\Users\\sonali.shinde\\.aws\\credentials).
         */
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (C:\\Users\\sonali.shinde\\.aws\\credentials), and is in valid format.",
                    e);
        }
