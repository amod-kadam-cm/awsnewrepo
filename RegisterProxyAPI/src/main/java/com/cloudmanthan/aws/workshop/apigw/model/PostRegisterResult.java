...
public class PostRegisterResult extends com.amazonaws.opensdk.BaseResult implements Serializable, Cloneable {
    ...
    public PostRegisterResult empty(Empty empty) {
        setEmpty(empty);
        return this;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PostRegisterResult == false)
            return false;
        PostRegisterResult other = (PostRegisterResult) obj;
    ...
    @Override
    public PostRegisterResult clone() {
        try {
            return (PostRegisterResult) super.clone();
